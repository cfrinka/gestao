...
const navigation = [
  ...
  { name: "Clientes", href: "/clients", icon: UserCheck, roles: ["ADMIN", "CASHIER"] },
  ...
  { name: "Correções de Débito", href: "/debt-corrections", icon: FileText, roles: ["ADMIN"] },
  { name: "Códigos de Barras", href: "/barcodes", icon: Barcode, roles: ["ADMIN", "CASHIER"] },
